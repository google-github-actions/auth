...
function createApplicationCredentials(workloadIdentityProvider, serviceAccount, githubOIDCToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const oidcTokenPath = path_1.default.join(rootDir, (0, uuid_1.v4)());
        yield fs_1.promises.writeFile(oidcTokenPath, githubOIDCToken);
        ...
        const jsonFile = path_1.default.join(rootDir, (0, uuid_1.v4)());
        yield fs_1.promises.writeFile(jsonFile, JSON.stringify(jsonContent, null, 2));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (tokenFormat === 'application_credentials') {
                yield createApplicationCredentials(workloadIdentityProvider, serviceAccount, githubOIDCToken);
                return;
            }
